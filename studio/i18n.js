...
(function (global) {
  ...
  const messages = {
    de: {
      "share.title": "Teilen",
      "share.description": "Erzeugt einen Link zu einer bearbeitbaren Momentaufnahme. Spätere Änderungen ändern den Link nicht.",
      "share.scope": "Umfang",
      "share.current": "Aktuelles Etikett",
      "share.document": "Gesamtes Dokument",
      "share.link": "Freigabelink",
      "share.privacy": "Jeder mit dem Link kann den Inhalt lesen – auch enthaltene Editor-Metadaten und ausgeblendete Elemente. Der Link ist nicht verschlüsselt oder widerrufbar. Empfänger benötigen Zugriff auf diese Studio-Adresse.",
      "share.copy": "Link kopieren",
      "share.file": "ZPL-Datei herunterladen",
      "export.json": "Studio-JSON",
      "file.open.formats": "ZPL / JSON öffnen…",
      "file.open.formats.title": "ZPL- oder Studio-JSON-Datei öffnen",
      "export.json.title": "Ganzes Dokument als portables JSON speichern",
      "export.json.ready": "„{name}“ heruntergeladen. Über „Datei öffnen…“ wieder importierbar.",
      "export.json.tooLarge": "Für Studio-JSON ist das Dokument zu groß. Bitte als ZPL herunterladen.",
      "export.json.failed": "Studio-JSON konnte nicht erstellt werden: {error}",
      "share.working": "Link wird erzeugt…",
      "share.ready": "Link bereit ({length} Zeichen).",
      "share.long": "Langer Link ({length} Zeichen; empfohlen: bis 8.000). Bei Problemen mit der Weitergabe die ZPL-Datei verwenden.",
      "share.copied": "Link in die Zwischenablage kopiert.",
      "share.manual": "Link ist markiert. Bitte mit Strg/Cmd+C kopieren.",
      "share.replace": "„{name}“ mit {count} Etikett(en) öffnen und den aktuellen Arbeitsstand ersetzen? Nicht gespeicherte Änderungen gehen dabei verloren. Abbrechen behält den Arbeitsstand.",
      "share.opened": "Geteiltes Dokument mit {count} Etikett(en) geöffnet. Änderungen bleiben zunächst lokal.",
      "share.error.invalid": "Der Freigabelink enthält ungültige Daten. Der Arbeitsstand bleibt erhalten.",
      "share.error.tooLarge": "Zu groß für einen Freigabelink. Bitte die ZPL-Datei weitergeben.",
      "share.error.unsupported": "Dieser Browser unterstützt die benötigte Kompression nicht. Bitte eine ZPL-Datei verwenden oder einen aktuellen Browser öffnen.",
      "share.error.corrupt": "Der Freigabelink ist beschädigt oder unvollständig. Bitte den vollständigen Link erneut kopieren.",
      "share.error.version": "Diese Version des Freigabelinks wird nicht unterstützt.",
      "share.error.url": "Zum Teilen wird eine vollständige HTTP(S)-Adresse von ZPLkit-Studio benötigt.",

      "console.scope.short": "Etikett {index}/{count}",
      "Export & Druck": "Export & Druck",
      "Weitere Funktionen": "Weitere Funktionen",
      "Hinweise": "Hinweise",
      "Erklärung": "Erklärung",
      "console.help.short": "Änderungen am Code mit „Übernehmen“ ins Etikett laden. Die Konsole bearbeitet das aktuelle Etikett.",
      ...
      'metadata.print-exported': 'Druck-ZPL ohne Editor-Metadaten als „{name}“ exportiert.',
    ...
    en: {
      "share.title": "Share",
      "share.description": "Creates a link to an editable snapshot. Later changes do not update the link.",
      "share.scope": "Include",
      "share.current": "Current label",
      "share.document": "Entire document",
      "share.link": "Share link",
      "share.privacy": "Anyone with the link can read its content, including editor metadata and hidden elements. Links are not encrypted or revocable. Recipients need access to this Studio address.",
      "share.copy": "Copy link",
      "share.file": "Download ZPL file",
      "export.json": "Studio JSON",
      "file.open.formats": "Open ZPL / JSON…",
      "file.open.formats.title": "Open a ZPL or Studio JSON file",
      "export.json.title": "Save the entire document as portable JSON",
      "export.json.ready": "Downloaded “{name}”. Import it again with “Open file…”.",
      "export.json.tooLarge": "This document is too large for Studio JSON. Download it as ZPL instead.",
      "export.json.failed": "Could not create Studio JSON: {error}",
      "share.working": "Creating link…",
      "share.ready": "Link ready ({length} characters).",
      "share.long": "Long link ({length} characters; recommended: up to 8,000). Share the ZPL file if the link cannot be passed on.",
      "share.copied": "Link copied to clipboard.",
      "share.manual": "Link selected. Press Ctrl/Cmd+C to copy.",
      "share.replace": "Open “{name}” with {count} label(s) and replace the current work? Unsaved changes will be lost. Cancel keeps the current work.",
      "share.opened": "Opened shared document with {count} label(s). Changes remain local.",
      "share.error.invalid": "The share link contains invalid data. Your work is unchanged.",
      "share.error.tooLarge": "Too large for a share link. Share the ZPL file instead.",
      "share.error.unsupported": "This browser does not support the required compression. Use a ZPL file or a current browser.",
      "share.error.corrupt": "The share link is damaged or incomplete. Copy the entire link again.",
      "share.error.version": "This share link version is not supported.",
      "share.error.url": "Sharing requires an absolute HTTP(S) ZPLkit-Studio address.",

      "console.scope.short": "Label {index}/{count}",
      "Export & Druck": "Export & print",
      "Weitere Funktionen": "More tools",
      "Hinweise": "Help",
      "Erklärung": "Explained",
      "console.help.short": "Apply code changes to update the label. The console edits the current label.",
      ...
      'metadata.print-exported': 'Print-ready ZPL exported without editor metadata as “{name}”.',
      ...
      'Druck-ZPL': 'Print ZPL',
      'Druck-ZPL ohne Editor-Metadaten herunterladen': 'Download print-ready ZPL without editor metadata',
    ...
    fr: {
      ...
      "share.description": "Crée un lien vers un instantané modifiable. Les modifications ultérieures ne changent pas le lien.",
      "share.scope": "Contenu",
      "share.current": "Étiquette courante",
      "share.document": "Document entier",
      "share.link": "Lien de partage",
      "share.privacy": "Toute personne disposant du lien peut lire son contenu, y compris les métadonnées et éléments masqués. Le lien n’est ni chiffré ni révocable. Le destinataire doit avoir accès à cette adresse Studio.",
      "share.copy": "Copier le lien",
      "share.file": "Télécharger le fichier ZPL",
      "export.json": "JSON Studio",
      "file.open.formats": "Ouvrir ZPL / JSON…",
      "file.open.formats.title": "Ouvrir un fichier ZPL ou JSON Studio",
      "export.json.title": "Enregistrer tout le document en JSON portable",
      "export.json.ready": "« {name} » téléchargé. Réimportez-le avec « Ouvrir un fichier… ».",
      "export.json.tooLarge": "Le document est trop volumineux pour le JSON Studio. Téléchargez-le en ZPL.",
      "export.json.failed": "Impossible de créer le JSON Studio : {error}",
      "share.working": "Création du lien…",
      "share.ready": "Lien prêt ({length} caractères).",
      "share.long": "Lien long ({length} caractères ; recommandé : jusqu’à 8 000). Partagez le fichier ZPL en cas de problème.",
      "share.copied": "Lien copié dans le presse-papiers.",
      "share.manual": "Lien sélectionné. Appuyez sur Ctrl/Cmd+C pour copier.",
      "share.replace": "Ouvrir « {name} » avec {count} étiquette(s) et remplacer le travail courant ? Les modifications non enregistrées seront perdues. Annuler conserve le travail courant.",
      "share.opened": "Document partagé ouvert avec {count} étiquette(s). Les modifications restent locales.",
      "share.error.invalid": "Le lien contient des données invalides. Votre travail est conservé.",
      "share.error.tooLarge": "Trop volumineux pour un lien. Partagez le fichier ZPL.",
      "share.error.unsupported": "Ce navigateur ne prend pas en charge la compression requise. Utilisez un fichier ZPL ou un navigateur récent.",
      "share.error.corrupt": "Le lien est endommagé ou incomplet. Copiez à nouveau le lien entier.",
      "share.error.version": "Cette version du lien de partage n’est pas prise en charge.",
      "share.error.url": "Le partage nécessite une adresse HTTP(S) absolue de ZPLkit-Studio.",

      "console.scope.short": "Étiquette {index}/{count}",
      "Export & Druck": "Exporter / imprimer",
      "Weitere Funktionen": "Autres outils",
      "Hinweise": "Aide",
      "Erklärung": "Explications",
      "console.help.short": "Appliquez les modifications du code pour actualiser l’étiquette. La console modifie l’étiquette courante.",
      ...
      'metadata.print-exported': 'ZPL d’impression exporté sans métadonnées de l’éditeur sous « {name} ».',
      ...
      'Druck-ZPL': 'ZPL impression',
      'Druck-ZPL ohne Editor-Metadaten herunterladen': 'Télécharger le ZPL d’impression sans métadonnées de l’éditeur',
